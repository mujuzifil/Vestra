...
class SettingSeeder extends Seeder
{
    public function run(): void
    {
        $settings = [
            ...
            // Social (existing)
            ['key' => 'facebook', 'value' => 'https://facebook.com/vestra', 'type' => SettingType::STRING, 'group' => SettingGroup::SOCIAL, 'label' => 'Facebook', 'sort_order' => 1],
            ['key' => 'instagram', 'value' => 'https://instagram.com/vestra', 'type' => SettingType::STRING, 'group' => SettingGroup::SOCIAL, 'label' => 'Instagram', 'sort_order' => 2],
            ['key' => 'linkedin', 'value' => 'https://linkedin.com/company/vestra', 'type' => SettingType::STRING, 'group' => SettingGroup::SOCIAL, 'label' => 'LinkedIn', 'sort_order' => 3],

            // Content (existing)
            ['key' => 'mission', 'value' => 'To deliver premium garment care solutions that protect your fabrics and the planet.', 'type' => SettingType::TEXT, 'group' => SettingGroup::CONTENT, 'label' => 'Mission', 'sort_order' => 1],
            ['key' => 'vision', 'value' => 'To become the global standard for professional and sustainable fabric care.', 'type' => SettingType::TEXT, 'group' => SettingGroup::CONTENT, 'label' => 'Vision', 'sort_order' => 2],
            ['key' => 'company_description', 'value' => 'VESTRA is a premium fabric care brand dedicated to developing high-performance cleaning solutions that combine advanced chemistry, innovation, and exceptional garment care.', 'type' => SettingType::TEXT, 'group' => SettingGroup::CONTENT, 'label' => 'Company Description', 'sort_order' => 3],
            ['key' => 'philosophy', 'value' => 'We believe fabric care should do more than clean. It should preserve, protect, and prolong the life of every garment we touch.', 'type' => SettingType::TEXT, 'group' => SettingGroup::CONTENT, 'label' => 'Philosophy', 'sort_order' => 4],
            ['key' => 'footer_text', 'value' => '© '.date('Y').' VESTRA. All rights reserved. Premium garment care solutions.', 'type' => SettingType::TEXT, 'group' => SettingGroup::CONTENT, 'label' => 'Footer Text', 'sort_order' => 5],
            ['key' => 'founded', 'value' => '2020', 'type' => SettingType::STRING, 'group' => SettingGroup::GENERAL, 'label' => 'Founded Year', 'sort_order' => 13],
            ['key' => 'headquarters', 'value' => 'Kampala, Uganda', 'type' => SettingType::STRING, 'group' => SettingGroup::GENERAL, 'label' => 'Headquarters', 'sort_order' => 14],
            ...
            ]), 'type' => SettingType::JSON, 'group' => SettingGroup::CONTENT, 'label' => 'Core Values', 'sort_order' => 6],
            ...
            ]), 'type' => SettingType::JSON, 'group' => SettingGroup::CONTENT, 'label' => 'Distributor Benefits', 'sort_order' => 7],
            ...
            ]), 'type' => SettingType::JSON, 'group' => SettingGroup::CONTENT, 'label' => 'Hero Features', 'sort_order' => 8],
            ...
            ]), 'type' => SettingType::JSON, 'group' => SettingGroup::CONTENT, 'label' => 'Promise Items', 'sort_order' => 9],
            ...
            ]), 'type' => SettingType::JSON, 'group' => SettingGroup::CONTENT, 'label' => 'Why Choose Features', 'sort_order' => 10],
            ...
            ]), 'type' => SettingType::JSON, 'group' => SettingGroup::CONTENT, 'label' => 'General FAQs', 'sort_order' => 11],
            ...
            ]), 'type' => SettingType::JSON, 'group' => SettingGroup::CONTENT, 'label' => 'Distributor FAQs', 'sort_order' => 12],
        ];
