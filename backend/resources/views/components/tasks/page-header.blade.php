...
<section class="vestra-workspace__hero">
    ...
    <div class="vestra-workspace__quick-actions vestra-tasks__header-actions">
        <div class="vestra-tasks__export-dropdown" x-data="{ open: false }" @click.outside="open = false">
            <button
                type="button"
                @click="open = !open"
            ...
            <div
                x-show="open"
                x-transition
                class="vestra-tasks__export-menu"
                role="menu"
            >
                <a href="{{ $csvUrl }}" class="vestra-tasks__export-option" role="menuitem">
                    <x-filament::icon icon="heroicon-o-document-text" class="h-4 w-4" />
                    <span>Export CSV</span>
                </a>
                <a href="{{ $excelUrl }}" class="vestra-tasks__export-option" role="menuitem">
                    <x-filament::icon icon="heroicon-o-table-cells" class="h-4 w-4" />
                    <span>Export Excel</span>
                </a>
                <a href="{{ $pdfUrl }}" class="vestra-tasks__export-option" role="menuitem">
