        ...
        @if ($role)
            <div class="vestra-roles-detail__header">
                <div class="vestra-roles-detail__header-main">
                    ...
                    <div class="vestra-roles-detail__header-text">
                        ...
                        <p class="vestra-roles-detail__subtitle">{{ $role['guard_name'] ?? '' }}</p>
                    </div>
                </div>
            ...
            <div class="vestra-roles-detail__body">
                <div class="vestra-roles-detail__badges">
                    <x-roles.type-badge :is-system="$role['is_system'] ?? false" />
                </div>
                ...
                <div class="vestra-roles-detail__section">
                    ...
                    @if (! empty($role['description']))
                        <p class="vestra-roles-detail__text">{{ $role['description'] }}</p>
                    @endif
                </div>
                    ...
                    @if (! empty($role['permissions']))
                        <div class="vestra-roles-detail__badges">
                            @foreach ($role['permissions'] as $permission)
                                <span class="vestra-roles__permission-pill">{{ $permission['name'] }}</span>
                            @endforeach
                        </div>
                    @else
