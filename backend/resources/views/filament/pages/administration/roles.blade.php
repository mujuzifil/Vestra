...
<x-filament-panels::page>
    <div class="vestra-workspace vestra-roles">
        <x-roles.page-header
            title="Roles"
            description="Manage platform roles and their permission assignments."
        ...
        <section class="vestra-workspace__section" aria-label="Role metrics">
            <x-roles.kpi-cards :cards="$kpiCards" />
        </section>

        <section class="vestra-workspace__section vestra-roles__content" aria-label="Role list">
