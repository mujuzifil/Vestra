...
<x-filament-panels::page>
    <div class="vestra-workspace vestra-staff">
        ...
        <section class="vestra-workspace__section" aria-label="Staff list">
            <div class="vestra-card vestra-staff__table-card">
                ...
                @if ($staff->total() > 0)
                    <x-staff.staff-table :staff="$staff" :sort-field="$sortField" :sort-direction="$sortDirection" />
        ...
        <x-staff.detail-drawer :show="$showDetailDrawer" :staff="$selectedStaff" />
    </div>
</x-filament-panels::page>
