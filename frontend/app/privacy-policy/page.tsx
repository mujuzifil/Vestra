      ...
      <main>
        ...
        <Container className="max-w-4xl">
          <div className="prose prose-lg max-w-none text-body">
            ...
            <h2 className="text-2xl font-bold text-primary-900 mt-8 mb-4">5. Your Rights</h2>
            <p>
              You have the right to access, update, or request deletion of your personal
              information. Contact us to exercise these rights.
            </p>

            <h2 className="text-2xl font-bold text-primary-900 mt-8 mb-4">6. Changes to This Policy</h2>
            <p>
              We may update this privacy policy from time to time. Changes will be posted on this
              page with an updated effective date.
            </p>

            <h2 className="text-2xl font-bold text-primary-900 mt-8 mb-4">7. Contact Us</h2>
            <p>
