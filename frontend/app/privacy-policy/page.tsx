      ...
      <main>
        ...
        <Container className="max-w-4xl">
          <div className="prose prose-lg max-w-none text-text-body">
            <h2 className="text-2xl font-bold text-text-heading mt-8 mb-4">1. Information We Collect</h2>
            <p>
            ...
            <h2 className="text-2xl font-bold text-text-heading mt-8 mb-4">2. How We Use Your Information</h2>
            <p>
            ...
            <h2 className="text-2xl font-bold text-text-heading mt-8 mb-4">3. Information Sharing</h2>
            <p>
              We do not sell your personal information. We may share information with trusted
              service providers who assist us in operating our business.
            </p>

            <h2 className="text-2xl font-bold text-text-heading mt-8 mb-4">4. Data Security</h2>
            <p>
              We implement reasonable security measures to protect your information from
              unauthorized access, disclosure, or destruction.
            </p>

            <h2 className="text-2xl font-bold text-text-heading mt-8 mb-4">5. Your Rights</h2>
            <p>
              You have the right to access, update, or request deletion of your personal
              information. Contact us to exercise these rights.
            </p>

            <h2 className="text-2xl font-bold text-text-heading mt-8 mb-4">6. Changes to This Policy</h2>
            <p>
              We may update this privacy policy from time to time. Changes will be posted on this
              page with an updated effective date.
            </p>

            <h2 className="text-2xl font-bold text-text-heading mt-8 mb-4">7. Contact Us</h2>
            <p>
              If you have any questions about this privacy policy, please contact us at
              info@vestradetergents.com.
            </p>
          </div>
        </Container>
      </section>
