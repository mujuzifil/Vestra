  ...
  return (
    <>
      ...
      <main>
          ...
          <Container>
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start">
              ...
              <div>
                ...
                <h1 className="text-3xl lg:text-4xl font-extrabold text-primary-900 mb-4 tracking-tight">
                  {product.name}
                </h1>
                <p className="text-2xl lg:text-3xl font-extrabold text-primary-500 mb-4">
                ...
                {product.benefits && product.benefits.length > 0 && (
                  <div className="mb-8">
                    <h3 className="text-lg font-bold text-primary-900 mb-3">Benefits</h3>
                ...
                {product.features && product.features.length > 0 && (
                  <div className="mb-8">
                    <h3 className="text-lg font-bold text-primary-900 mb-3">Key Features</h3>
                    <div className="flex flex-wrap gap-2">
                      {product.features.map((feature) => (
                        <span
                          key={feature}
                          className="px-4 py-2 rounded-full text-sm font-medium bg-neutral-100 text-body"
                        >
                          {feature}
                        </span>
                      ))}
                ...
                {product.specifications && Object.keys(product.specifications).length > 0 && (
                  <div className="rounded-[16px] border border-default overflow-hidden">
                    <table className="w-full text-sm">
                      <tbody>
                        {Object.entries(product.specifications).map(([key, value]) => (
                          <tr key={key} className="border-b border-default last:border-0">
                            <td className="px-5 py-3 font-semibold text-primary-900 bg-surface-page">
                              {key}
                            </td>
        ...
        {/* Reviews Section */}
        <section className="py-16 lg:py-24 bg-surface-page">
          <Container>
            <div className="grid lg:grid-cols-3 gap-12">
              <div className="lg:col-span-1">
                <h2 className="text-2xl font-extrabold text-primary-900 mb-4">Customer Reviews</h2>
