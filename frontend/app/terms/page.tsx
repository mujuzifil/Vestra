      ...
      <main>
        ...
        <Container className="max-w-4xl">
          <div className="prose prose-lg max-w-none text-body">
            ...
            <h2 className="text-2xl font-bold text-primary-900 mt-8 mb-4">2. Use of Website</h2>
            <p>
            ...
            <h2 className="text-2xl font-bold text-primary-900 mt-8 mb-4">3. Products and Pricing</h2>
            <p>
            ...
            <h2 className="text-2xl font-bold text-primary-900 mt-8 mb-4">4. Distributor Applications</h2>
            <p>
            ...
            <h2 className="text-2xl font-bold text-primary-900 mt-8 mb-4">5. Intellectual Property</h2>
            <p>
            ...
            <h2 className="text-2xl font-bold text-primary-900 mt-8 mb-4">6. Limitation of Liability</h2>
            <p>
            ...
            <h2 className="text-2xl font-bold text-primary-900 mt-8 mb-4">7. Governing Law</h2>
            <p>
              These terms are governed by the laws of Uganda. Any disputes shall be resolved in the
              courts of Uganda.
            </p>

            <h2 className="text-2xl font-bold text-primary-900 mt-8 mb-4">8. Contact</h2>
            <p>
