...
const resources = [
  { icon: "Package", title: "Products", description: "Browse our full range of professional cleaning products.", href: "/products" },
  { icon: "Briefcase", title: "Become a Distributor", description: "Partner with VESTRA® and grow your distribution business.", href: "/distributor" },
  { icon: "MapPin", title: "Where to Buy", description: "Find authorised retailers and distributors near you.", href: "/where-to-buy" },
  { icon: "Newspaper", title: "Blog", description: "Read insights on cleaning, business, and product usage.", href: "/blog" },
];

export function RelatedResourcesSection() {
  return (
    <section className="py-20 lg:py-28 bg-white" aria-labelledby="resources-heading">
      <Container>
        <SectionHeader
          id="resources-heading"
          title="Related Resources"
          subtitle="Explore more ways to work with VESTRA®."
        />
