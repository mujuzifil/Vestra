          ...
          <form onSubmit={handleSubmit} className="space-y-6 max-w-2xl">
            <div className="bg-white rounded-[20px] border border-[#e2e8f0] shadow-sm p-6 lg:p-8">
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  <h1 className="text-lg font-bold text-[#0a1628]">Notification Channels</h1>
                  <p className="text-sm text-[#64748b]">Select the channels and topics you want to receive.</p>
                </div>
              </div>
