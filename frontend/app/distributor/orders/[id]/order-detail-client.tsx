  ...
  if (!order) {
    return (
      <div className="bg-white rounded-[20px] border border-neutral-200 shadow-sm p-8 text-center">
        ...
        <h2 className="text-lg font-bold text-text-heading">Order not found</h2>
          ...
          <div className="bg-white rounded-[20px] border border-neutral-200 shadow-sm p-6">
            ...
            <div className="space-y-4">
              {order.items.map((item) => {
                ...
                return (
                  <div key={item.id} className="flex flex-col sm:flex-row sm:items-center gap-4 p-4 rounded-xl bg-neutral-50">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-[20px] border border-neutral-200 shadow-sm p-6">
            ...
            <p className="text-sm text-muted">
              Method: <span className="font-medium text-text-heading capitalize">{order.payment_method.replace(/_/g, " ")}</span>
            </p>
            <p className="text-sm text-muted">
              Status:{" "}
              <span
