  ...
  if (!order) {
    return (
      <div className="bg-white rounded-[20px] border border-neutral-200 shadow-sm p-8 text-center">
        ...
        <h2 className="text-lg font-bold text-primary-900">Order not found</h2>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-[20px] border border-neutral-200 shadow-sm p-6">
            ...
            <p className="text-sm text-muted">
              Method: <span className="font-medium text-primary-900 capitalize">{order.payment_method.replace(/_/g, " ")}</span>
            </p>
            <p className="text-sm text-muted">
              Status:{" "}
              <span
