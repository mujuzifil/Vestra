...
export function WhatsAppFloat() {
  return (
    <Link
      ...
      className="fixed bottom-6 right-6 z-[999] w-14 h-14 rounded-full bg-whatsapp text-white flex items-center justify-center text-2xl shadow-lg hover:scale-110 hover:-translate-y-1 transition-all-base duration-300 group"
