...
type FormErrors = Partial<Record<keyof QuoteRequestFormData | "items" | "general" | "attachments", string>>;
...
function createEmptyForm(prefilledProduct = ""): QuoteRequestFormData {
  return {
    full_name: "",
    company_name: "",
    email: "",
...
export function QuoteForm() {
  ...
  const [formData, setFormData] = useState<QuoteRequestFormData>(() => createEmptyForm(prefilledProduct));
  ...
  return (
    <>
      ...
      <SubmissionSuccessDialog
        ...
        description="Thank you. Your quotation request has been received. Our sales team will contact you within 24–48 business hours."
