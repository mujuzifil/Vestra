...
const gradients = [
  ...
  "from-primary-500 to-primary-600 shadow-blue-500/25",
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {promiseItems.map((item, index) => (
            <motion.div
              ...
              className="flex items-start gap-4 p-6 lg:p-7 rounded-[20px] bg-white border border-default shadow-sm hover:-translate-y-1.5 hover:shadow-md hover:border-primary-300/50 transition-all-base"
            >
              <div
