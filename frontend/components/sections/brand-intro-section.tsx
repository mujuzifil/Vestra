    ...
    <section id="about" className="py-24 lg:py-36 bg-white">
      <Container>
        <div className="grid md:grid-cols-2 lg:grid-cols-[0.9fr_1.3fr_0.5fr] gap-12 lg:gap-16 items-center">
          ...
          >
            <div className="relative w-[170px] h-[210px] rounded-[20px] bg-gradient-to-br from-primary-900/85 to-primary-500/75 backdrop-blur-sm text-white flex flex-col items-center justify-center text-center p-6 shadow-lg border border-accent-500/40 overflow-hidden">
              <div className="absolute inset-2 border border-accent-500/50 rounded-[12px]" />
              <Shield className="w-12 h-12 text-accent-500 mb-4 relative z-10" />
              <span className="text-base font-extrabold leading-tight text-accent-300 mb-2 relative z-10">
                PROFESSIONAL
                <br />
                QUALITY
              </span>
